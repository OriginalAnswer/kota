...
// ---------------------------------------------------------------------------------------------
export const saveRate1 = (text, statu, when,sn) => setDoc(doc(db, "rate-1", when), {text,statu,when,sn});
...
// ---------------------------------------------------------------------------------------------
export const saveRate2 = (text, statu, when,sn) => setDoc(doc(db, "rate-2", when), {text,statu,when,sn});
...
// ---------------------------------------------------------------------------------------------
export const saveRate3 = (text, statu, when,sn) => setDoc(doc(db, "rate-3", when), {text,statu,when,sn});
...
// ---------------------------------------------------------------------------------------------
export const saveRate4 = (text, statu, when,sn) => setDoc(doc(db, "rate-4", when), {text,statu,when,sn});
...
// ---------------------------------------------------------------------------------------------
export const saveRate5 = (text, statu, when,sn) => setDoc(doc(db, "rate-5", when), {text,statu,when,sn});
...
// ---------------------------------------------------------------------------------------------
export const saveRate6 = (text, statu, when,sn) => setDoc(doc(db, "rate-6", when), {text,statu,when,sn});
